                ...
                <div className="space-y-3 pb-20">
                    {queue.map((appointment, index) => (
                        <div 
                            key={appointment.id}
                            className={cn(
                                "group bg-card rounded-xl border border-border/60 p-3 hover:shadow-lg dark:hover:shadow-lg/80 transition-all cursor-pointer relative overflow-hidden",
                                index === 0 && "border-primary/30 ring-1 ring-primary/5"
                            )}
