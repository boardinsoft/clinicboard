    ...
    return (
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <div className="w-10 h-10 rounded-full bg-s-warning-bg flex items-center justify-center text-s-warning mb-2">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-2">
                        ...
                        <DialogFooter className="pt-2">
                            ...
                            <Button 
                                ...
                                className="h-9 px-8 bg-s-warning hover:bg-s-warning/90 shadow-lg shadow-s-warning/20"
                            >
                                {isSubmitting ? (
