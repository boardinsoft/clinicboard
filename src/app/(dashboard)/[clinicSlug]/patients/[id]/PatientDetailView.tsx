                        ...
                        <div className="max-w-4xl mx-auto">
                            <Card>
                                ...
                                <CardContent className="p-0 divide-y divide-n-5/30">
                                    {conditions.length === 0 ? (
                                        <div className="p-8">
                                            <EmptyStatePresentational icon={Activity} title="No hay condiciones clínicas" description="El paciente no tiene diagnósticos registrados actualmente." />
                                        </div>
                                    ) : (
                                        conditions.map((c) => (
                        ...
                        <div className="max-w-4xl mx-auto">
                            <Card>
                                ...
                                <CardContent className="p-0 divide-y divide-n-5/30">
                                    {allergies.length === 0 ? (
                                        <div className="p-8">
                                            <EmptyStatePresentational icon={FlaskConical} title="Sin alergias registradas" description="No se han reportado alergias o intolerancias para este paciente." />
                                        </div>
                                    ) : (
                                        allergies.map((a) => (
                            ...
                            <Card>
                                ...
                                <CardContent className="p-0">
                                    {loadingEncounters ? (
                                        ...
                                        <div className="p-8">
                                            <EmptyStatePresentational icon={Calendar} title="Sin consultas previas" description="Este paciente aún no registra visitas clínicas." />
                                        </div>
                                    ) : (
